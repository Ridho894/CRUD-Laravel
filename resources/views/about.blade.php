...
@section('container')
        ...
        <div class="container py-5">
            <div class="row h-100 align-items-center py-5">
                <div class="col-lg-6">
                    ...
                    <p class="lead text-muted mb-0">Create a minimal all page using Bootstrap 4.</p>
                </div>
        ...
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                    <h2 class="font-weight-light">Auction your item on the website</h2>
                    <p class="font-italic text-muted mb-4">make it easier for many people to auction their goods.</p><a
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                    <h2 class="font-weight-light">Various Kinds of Rare Items</h2>
                    <p class="font-italic text-muted mb-4">Find the item you are looking for, at a price you set yourself on
                        our website</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row text-center">
                ...
                <div class="col-xl-3 col-sm-6 mb-5">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img
                        ...
                        <h5 class="mb-0">Muhamad Ridho Budikusuma</h5><span
    ...
    <footer class="bg-light pb-5">
        <div class="container text-center">
            <p class="font-italic text-muted mb-0">&copy; Copyrights Auction.com All rights reserved.</p>
        </div>
    </footer>
@endsection
